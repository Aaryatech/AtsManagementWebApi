...
public interface ProjTaskDetailRepo extends JpaRepository<ProjTaskDetail, Integer> {
	...
	@Query(value = " SELECT t_projects.project_name AS proj_name, t_task.task_id,t_task.start_date,t_task.dev_status, t_task.task_name,"
			...
			+ " FROM t_task,t_cmplx_option,m_employee,t_forms,t_modules,t_technology,t_projects "
			...
			+ "  AND t_projects.project_id=t_task.project_id"
